...
The following walk through will be based on [Creating a datepicker ember addon](http://edgycircle.com/blog/2014-creating-a-datepicker-ember-addon). The repo is [ember-pikaday](https://github.com/edgycircle/ember-pikaday)

This datepicker component uses the [Pikaday](https://github.com/dbushell/Pikaday) library for the datepicker functionality. [Moment.js](http://momentjs.com) is used for date format functionality.
